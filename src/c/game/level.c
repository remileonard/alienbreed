...
void level_init_variables(void)
{
     ...
     * level. */
    g_boss_active             = 0;
    g_boss_nbr                = k_level_defs[g_cur_level].boss_nbr;
